...
import org.d3if2129.sentralberas.ui.home.HomeViewModel


class RajaleleFragment : Fragment() {
    private var _binding: FragmentRajaleleBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRajaleleBinding.inflate(inflater, container, false)
